 ...
 * Bonus tile
 */
public class TileRailGun extends Tile {
     ...
     */
    public TileRailGun(int x, int y) {
        super(x, y, FilesUtils.getImage("assets/textures/tile/railgun.png"), FilesUtils.getImage("assets/textures/tile/ground.png"));
        state = Type.RAILGUN;
        image = 0;
    }
     ...
     */
    public TileRailGun(Coordinate coordinate) {
        super(coordinate, FilesUtils.getImage("assets/textures/tile/railgun.png"), FilesUtils.getImage("assets/textures/tile/ground.png"));
        state = Type.RAILGUN;
    }
